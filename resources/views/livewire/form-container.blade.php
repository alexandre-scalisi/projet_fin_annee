...
<div x-data="">
    ...
    <div class="form-container" id="form" @scroll.debounce="app().scrollFunc($event)">
        <div class="form-container__bg form-container__bg_top" x-data="" x-init="app().test($el)" id="bg-top" wire:ignore></div>
        ...
        <div class="form-container__bg form-container__bg_bottom" x-data="" x-init="app().test2($el)" id="bg-bottom" wire:ignore></div>
