<div
    class="bg-gray-900 bg-opacity-80 fixed top-0 left-0 h-screen w-screen z-50 flex flex-col items-center justify-center">
    <form action="{{ $action }}" method="POST" class="bg-white font-sans" style="width: 21rem">
        ...
        <div class="px-4 py-3 text-lg flex justify-between">
            <button class="bg-gray-900 px-8 py-2 rounded-full text-red-50 ">Confirmer</button> <button
