<footer class="text-center bg-blue-500 pt-8 pb-4">
    <ul class="flex justify-center items-center gap-3">
        <li><a href="https://github.com/alexandre-scalisi" class="fab fa-github fa-2x"><span class="sr-only">lien github</span></a></li>
