<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed w-full top-0 {{ auth()->user() && auth()->user()->role === 'admin' ? 'top-10' : '' }}" style="z-index: 9998">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="pt-2 pb-3 space-y-1 gap-x-4 px-4">
            <x-jet-nav-link href="{{ route('animes.index') }}" :active="request()->routeIs('animes.index')">
                {{ __('Animes') }}
            </x-jet-nav-link>
            <x-jet-nav-link href="{{ route('animes.action') }}" :active="request()->routeIs('animes.action')">
